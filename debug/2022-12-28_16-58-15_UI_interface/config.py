...
# env_name = "lego-test-11"
# env_name = "lego-test-12"
# env_name = "lego-test-13"
# env_name = "lego-test-14"
# env_name = "lego-test-15"
# env_name = "lego-test-16"
...
env_attribute_dict = {
    ...
    '30-60-90+rectangle'   : (True,  7, 7000),
    ...
    'lego-test-2.3'        : (True,  11, 5000),
    'lego-test-2.4'        : (True,  7, 5000),
    'lego-test-3'          : (True,  7, 5000),
    'lego-test-3.1'        : (True,  11, 5000),
    'lego-test-3.2'        : (False, 7, 1000),
    'lego-test-4'          : (True,  9, 2000),
    'lego-test-4.1'        : (True,  11,7000),
    'lego-test-4.2'        : (True,  7, 2000),
    'lego-test-4.3'        : (True,  5, 3000),
    'lego-test-5'          : (True,  7, 2000),
    'lego-test-6'          : (True,  11,7000),
    'lego-test-7'          : (True,  11,100),
    'lego-test-7.1'        : (True,  4,100),
    'lego-test-8'          : (True,  11,7000),
    'lego-test-8.1'        : (True,  11,2000),
    'lego-test-8.2'        : (True,  11,2000),
    'lego-test-8.3'        : (True,  11,50),
    'lego-test-9'          : (True,  11,500),
    'lego-test-10'         : (True,  11,7000),
    'lego-test-11'         : (True,  11,5000),
    'lego-test-12'         : (True,  5,100),
    'lego-test-13'         : (True,  11,2000),
    'lego-test-14'         : (True,  11,1000),
    'lego-test-15'         : (True,  11,5000),
    'lego-test-16'         : (True,  15,5000),
}
...
debug_data_num = 10
debug_base_folder = ".."
experiment_id = 5003 # unique ID to identify an experiment
